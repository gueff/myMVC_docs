...
This class is generated by myMVC's DataType Generator; see [/3.3.x/generating-datatype-classes](/3.3.x/generating-datatype-classes) for more Information.
...
- see `Request`: [Accessing Path Params / Variables](/3.3.x/request#Accessing-Path-Params-Variables)
